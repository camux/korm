import pytest
from korm.statements import Statement, select, insert, \
    update, delete, _callback, _reset_counter
from korm.statements.base_statement import StatementValues, \
    ClauseDescriptor, StatementDescriptor
from korm.statements.abstract import StatementABC
from korm.exceptions import InvalidModel
